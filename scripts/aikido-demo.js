...
server.listen(PORT, () => {
    ...
    console.log(`   http://localhost:${PORT}/security-test?input=<script>alert("xss")</script>`);
    console.log(`   http://localhost:${PORT}/security-test?input='; DROP TABLE users; --`);
    console.log(`   http://localhost:${PORT}/security-test?file=../../../etc/passwd`);
    console.log('');
