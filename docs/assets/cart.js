...
class FreshThreadsCart {
  ...
  createCartHTML() {
    ...
    this.paypalContainer = cartSidebar.querySelector(
  ...
  bindAddToCartButtons() {
    ...
    document
      .querySelectorAll(".add-to-cart-btn, [data-add-to-cart]")
      .forEach((button) => {
    ...
    document
      .querySelectorAll(".product-card, .product-item")
      .forEach((productCard) => {
        if (
          !productCard.querySelector(".add-to-cart-btn") &&
          !productCard.querySelector("[data-add-to-cart]")
        ) {
  ...
  addCartButtonToProduct(productCard) {
    ...
    if (productData.id && productData.name && productData.price) {
      ...
      const actionsContainer =
        productCard.querySelector(".product-actions") ||
  ...
  extractProductData(productCard) {
    ...
    const data = {
      ...
      name:
        productCard.getAttribute("data-product-name") ||
        productCard
          .querySelector("h3, .product-name, .product-title")
          ?.textContent?.trim() ||
        "Product",
      price: this.extractPrice(productCard),
      image:
        productCard.getAttribute("data-product-image") ||
  ...
  handleAddToCart(e) {
    ...
    const productData = {
      ...
      name:
        ...
        button
          .closest(".product-card, .product-item")
          ?.querySelector("h3, .product-name")
          ?.textContent?.trim() ||
        "Product",
      price:
      ...
      image:
        ...
        button.closest(".product-card, .product-item")?.querySelector("img")
          ?.src ||
        "assets/Fresh_ThreadsLLCLogo.png",
  ...
  showAddToCartNotification(product) {
    ...
    // Close button
    notification
      .querySelector(".cart-notification-close")
  ...
  loadPayPalSDK() {
    ...
    script.src =
      "https://www.paypal.com/sdk/js?client-id=AUIlZ3WG9CHyHlQVfHRaZKr2RvzJFw35h4A6LN-7iYS8_k-U88n8rh-BLqCQa2XGv8v1LZQj8I8bKxVi&currency=USD&intent=capture";
    script.onload = () => {
